        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BuyerFirstName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    BuyerLastName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    BuyerEmail = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    BuyerPhone = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    RecipientFirstName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    RecipientLastName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    RecipientPhone = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    DeliveryAddress = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    DeliveryCity = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    SenderFirstName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    SenderLastName = table.Column<string>(type: "nvarchar(120)", maxLength: 120, nullable: false),
                    SenderPhone = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    PayoutCardMasked = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
